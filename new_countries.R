...
existing_names <- read.csv("JohnsHopkins-to-A3_no-non-breaking-spaces.csv")$Country.Region %>% as.character()
...
readr::write_lines(new_countries, path = "new_countries_no-non-breaking-spaces.txt")
readr::write_lines(removed_countries, path = "removed_countries_no-non-breaking-spaces.txt")
